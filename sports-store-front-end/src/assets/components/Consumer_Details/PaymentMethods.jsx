    ...
    <>
      ...
      <div className="bg-white grid-col-[repeat(1,minmax(min-content, max-content))] mt-16">
        <div className="lg:hidden block">
          <div className="pt-4 px-6 pb-px bg-stone-100 mt-3">
            <div className="flex items-center justify-between">
              ...
              <div className="underline font-semibold hover:text-red-500 cursor-pointer">
                Sign Out
              </div>
            </div>
        ...
        <div className="ml-11 p-5 block lg:hidden">
          <button
            onClick={setIsOpen}
            className="md:w-48 w-full h-12 bg-neutral-800 hover:bg-neutral-500 text-white font-semibold mb-10 rounded-md"
          >
            Add Payment Method
          </button>
        </div>
